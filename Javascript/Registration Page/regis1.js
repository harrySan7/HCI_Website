    ...
    function showSuccessMessage() {
        ...
        formContainer.innerHTML = `
            <div style="text-align: center; padding: 3rem 2rem; background-color: rgba(255, 255, 255, 0.95); border-radius: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                ...
                <h2 style="color: var(--success); font-size: 2.5rem; margin: 1.5rem 0 1rem; font-weight: 700;">Pendaftaran Berhasil!</h2>
                <p style="color: var(--text-color); font-size: 1.3rem; margin-bottom: 2rem; line-height: 1.6;">
                    Terima kasih telah mendaftar QRIS InterActive. Tim kami akan menghubungi Anda melalui WhatsApp dalam <strong>1x24 jam</strong> untuk proses verifikasi dan aktivasi akun.
                </p>
                
                <div style="background: var(--gray-100); padding: 2rem; border-radius: 16px; margin: 2rem 0; border: 2px solid var(--primary-color);">
                    <h3 style="color: var(--primary-color); margin-bottom: 1.5rem; font-size: 1.4rem; font-weight: 600;">Langkah Selanjutnya:</h3>
                    <div style="text-align: left; display: grid; gap: 1rem;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            ...
                            <span style="font-size: 1.1rem; color: var(--text-color);">Verifikasi dokumen melalui WhatsApp</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <div style="width: 32px; height: 32px; background: var(--success); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fas fa-user-check" style="color: white; font-size: 0.9rem;"></i>
                            </div>
                            <span style="font-size: 1.1rem; color: var(--text-color);">Aktivasi akun QRIS</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <div style="width: 32px; height: 32px; background: var(--success); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fas fa-qrcode" style="color: white; font-size: 0.9rem;"></i>
                            </div>
                            <span style="font-size: 1.1rem; color: var(--text-color);">Pemasangan QR Code di toko Anda</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="background: rgba(144, 31, 31, 0.05); padding: 1.5rem; border-radius: 12px; margin: 1.5rem 0; border-left: 4px solid var(--primary-color);">
                    <p style="color: var(--text-color); font-size: 1rem; margin: 0; display: flex; align-items: center; gap: 8px;">
                        ...
                        <strong>Penting:</strong> Pastikan nomor WhatsApp Anda aktif untuk menerima konfirmasi dari tim kami.
                    </p>
                </div>
                
                <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin-top: 2rem;">
                    <button onclick="location.href='/HTML/document-upload/doc.html'" style="background: var(--primary-color); color: white; border: none; padding: 1rem 2rem; border-radius: 30px; font-weight: 600; cursor: pointer; font-size: 1.1rem; transition: all 0.3s ease; display: flex; align-items: center; gap: 8px;">
