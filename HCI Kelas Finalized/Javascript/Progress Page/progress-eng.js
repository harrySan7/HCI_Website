document.addEventListener('DOMContentLoaded', function() {
    ...
    let companyName = 'Your Store Name';
    let regDate = null;
    const userEmail = localStorage.getItem('userEmail');

    if (userEmail) {
        // Get company name and registration date for this user
        companyName = localStorage.getItem(`progressCompany_${userEmail}`) || 'Your Store Name';
    ...
    if (regDateElem && regDate) {
        ...
        regDateElem.textContent = `Registration ID: #QRS-2025-001234 | Registration Date: ${formattedDate}`;
    }
    ...
    if (regDate) {
        ...
        function updateCountdown() {
            ...
            if (targetDateElem) {
                ...
                targetDateElem.textContent = countdownTarget.toLocaleDateString('en-US', options);
            }
        }
    ...
    if (regDate) {
        function formatDate(date, withTime = false) {
            ...
            if (withTime) {
                str += ', ' + date.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' });
            }
            return str;
        }
    ...
    setTimeout(() => {
        showNotification('ID Card document has been verified ✓', 'success');
    }, 10000);

    setTimeout(() => {
        showNotification('Verification team is reviewing your Business License', 'info');
    }, 25000);
