document.addEventListener('DOMContentLoaded', function() {
    ...
    const loginLink = document.querySelector('.header-dir a[href*="sign-in"]');
    const createAccountLink = document.querySelector('.header-dir a[href*="sign-eng"]');
    ...
    if (isLoggedIn === 'true' && userName) {
        ...
        if (createAccountLink) createAccountLink.style.display = '';
    }
