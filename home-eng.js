document.addEventListener('DOMContentLoaded', function() {
    ...
    if (daftarQrisBtn) {
        daftarQrisBtn.addEventListener('click', function(e) {
            ...
            if (isLoggedIn === 'true') {
                e.preventDefault();
                window.location.href = '/HTML/registration/regis-eng.html';
            } else {
                e.preventDefault();
                window.location.href = '/HTML/Sign In Page/sign-in-eng.html';
            }
        });
    }
    ...
    if (btn) {
        btn.addEventListener('click', function(e) {
            ...
            if (businessname && businessname.trim() !== '') {
                e.preventDefault();
                window.location.href = '/HTML/progress-track/progress-eng.html';
            } else {
                e.preventDefault();
                window.location.href = '/HTML/registration/regis-eng.html';
            }
    ...
    const masukLink = document.querySelector('.header-dir a[href*="sign-in-eng.html"]');
    const buatAkunLink = document.querySelector('.header-dir a[href*="sign-eng.html"]');
